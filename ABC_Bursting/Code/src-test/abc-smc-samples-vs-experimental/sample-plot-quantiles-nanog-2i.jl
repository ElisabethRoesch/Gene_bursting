...
for name in genes
      pathtofile_lisi = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/Data/ABC_output/RNAseq/testing_priors/model_1/nanog/500/2i/model1_",name,fileending,".txt")
...
for gene in 1:length(genes)
    ...
    name = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/plots/model-1-nanog/500/2i/", genes[gene],fileending,".png")
    savefig(name)
end

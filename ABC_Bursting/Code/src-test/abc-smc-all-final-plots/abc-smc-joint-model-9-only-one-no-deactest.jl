...
using StatPlots
using KernelDensity
name="ENSMUSG00000021835"
fileending_2i="model_9_serum_genes_2i_data_"
nsamples = 100
path_to_file_2i = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/Data/ABC_output/RNAseq/model_9_huge_no_deact/serum_genes/2i_data/",fileending_2i,name,"_david.txt")
path_to_plot = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/plots/validate/simulation/model_9",name,fileending_2i,"_joint_validate_fa.pdf")
...
fig, ax = PyPlot.subplots(figsize=(15,15),ncols=4, nrows=4)
      PyPlot.ioff()
      # truth = [-3.,-4.,3.,-3]
      sns.distplot(a3_2i,bins=15, kde= true, hist=true,rug= false ,color = "grey", label = "lisi",ax=ax[1,1])
      sns.distplot(b3_2i,bins=15, kde= true, hist=true,rug= false ,   color = "grey", label = "lisi",ax=ax[2,2])
      sns.distplot(c3_2i,bins=15, kde= true, hist=true,rug= false ,  color = "grey", label = "lisi",ax=ax[3,3])
      sns.distplot(d3_2i,bins=15, kde= true, hist=true,rug= false ,  color = "gray", label = "lisi",ax=ax[4,4])

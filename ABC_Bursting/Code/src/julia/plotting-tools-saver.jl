...
function plot_one_abacus_file_m1(pathtofile_lisi, pathtoplot, number_abc_smc, number_particles, number_unknown_params)
    ...
    d3=d3[1:end-2]
    PyPlot.ioff()
    fig, ax = PyPlot.subplots(figsize=(15,15),ncols=3, nrows=4)
    ...
    sns.distplot([-4,4],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[1,1])
    sns.distplot([-4,4],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[1,2])
    sns.distplot([-4,4],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[1,3])


    sns.distplot([-4,4],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[2,1])
    sns.distplot([-4,4],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[2,2])
    sns.distplot([-4,4],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[2,3])


    sns.distplot([-4,2],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[3,1])
    sns.distplot([-4,2],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[3,2])
    sns.distplot([-4,2],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[3,3])


    sns.distplot([-2,6],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[4,1])
    sns.distplot([-2,6],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[4,2])
    sns.distplot([-2,6],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[4,3])
...
function plot_one_abacus_file_m8(pathtofile_lisi, pathtoplot, number_abc_smc, number_particles, number_unknown_params)
    ...
    sns.distplot([-4,4],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[3,1])
    sns.distplot([-4,4],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[3,2])
    sns.distplot([-4,4],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[3,3])
    ...
    sns.distplot([-2,6],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[5,1])
    sns.distplot([-2,6],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[5,2])
    sns.distplot([-2,6],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[5,3])
    PyPlot.savefig(pathtoplot)
...
function plot_one_abacus_file_m9(pathtofile_lisi, pathtoplot, number_abc_smc, number_particles, number_unknown_params)
    ...
    sns.distplot([-4,4],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[4,1])
    sns.distplot([-4,4],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[4,2])
    sns.distplot([-4,4],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[4,3])


    sns.distplot([-4,2],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[5,1])
    sns.distplot([-4,2],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[5,2])
    sns.distplot([-4,2],bins=20,  kde= false, hist=true,rug= false ,  color = "white", label = "lisi",ax=ax[5,3])

...
@sync @parallel for i in gene_names[selectionstart:selectionend]
    ...
    #Define output file
    #----------------------------------------------------------------
    outfile_name = "$(outfile)/model9_$(i)_2i_RNAseq_0.122_SMC_ratiotoproduction_transformed.txt"
    ...
    priors = [Distributions.Uniform(-3.0,3.0),
        ...
        Distributions.Uniform(0.0,5.0)] #changes from 0.0,5.0
    #Define parameters for SMC
    n_params = 6 #number of parameters to be inferred
    n_particles = 1000 #number of particles accepted

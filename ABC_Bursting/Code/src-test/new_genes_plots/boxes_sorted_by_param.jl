...
for name in genes
      ...
      ax = sns.boxplot(x="Parameters", y="c",data=gene, hue="Condition", palette="Set1")
      ...
      #here 2
      name = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/plots/params/new_genes/",my_label,"_boxplot_sorted_params.pdf")
      savefig(name)
...
#       ax[:tick_params](labelsize=16)
#       #here 2
#       name = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/plots/params/new_genes/",my_label,"_serum_only.pdf")
#       savefig(name)
# end
#
# countergene = 0
...
#       name = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/plots/params/new_genes/",my_label,"_2i_only.pdf")
#       savefig(name)
# end
#

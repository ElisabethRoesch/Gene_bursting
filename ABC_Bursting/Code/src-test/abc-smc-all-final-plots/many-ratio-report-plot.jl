...
fig,ax = PyPlot.subplots()
      ...
      PyPlot.plot([Deact_serum_trns],[Act_serum_trns], color="cornflowerblue", label="serum", markersize=15, marker = "*", linestyle="")
      PyPlot.plot([Deact_2i_trns], [Act_2i_trns], color="salmon", marker ="*",  label="2i",markersize=15, linestyle="" )

       PyPlot.plot(all_centroid_x_serum, all_centroid_y_serum, label="serum", color="cornflowerblue", markersize=15, marker = "o", linestyle="")
       PyPlot.plot(all_centroid_x_2i, all_centroid_y_2i, label="2i",color="salmon", marker ="o",markersize=15, linestyle="")
       ...
       ax[:annotate]("base model",xy=(centroid_x_2i, centroid_y_2i), xytext = (centroid_x_2i+0.1, centroid_y_2i+0.1),fontsize = 12,zorder=100)
      ...
      # sns.regplot(m8_r_deact_deg_serum, m8_r_act_deg_serum ,color="cornflowerblue")
      # sns.regplot(m8_r_deact_deg_2i, m8_r_act_deg_2i, color = "salmon")
      # sns.regplot(m9_r_deact_deg_serum, m9_r_act_deg_serum ,color="cornflowerblue")
      # sns.regplot(m9_r_deact_deg_2i, m9_r_act_deg_2i, color = "salmon")

      # ax[:set_title](string(n_tester," params sampled for posterior(",n_samples,", ", tmax,") of Nanog"))
# savefig(string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/plots/validate/nanog/",tau,genes[1],fileending_serum,"vs2i.pdf"))

print("serum")
print(Deact_serum_trns,Act_serum_trns)
print("2i")
print(Deact_2i_trns,Act_2i_trns)

print("serum")
print(all_centroid_x_serum,all_centroid_y_serum)
print("2i")
print(all_centroid_x_2i,all_centroid_y_2i)

...
@sync @parallel for i in gene_names[selectionstart:selectionend]
    test_data = generate_single_simulation_samples_m9_no_deact_half(newTrue,250, data_scaling_RNAseq)

    #Define output file
    #----------------------------------------------------------------
    outfile_name = "$(outfile)/validate_model_9_david_100_01_250_3_0c2_new_prior_save.txt"
    ...
    priors = [Distributions.Uniform(-6.0,0.0),
        ...
        Distributions.Uniform(-3.0,0.0),
        Distributions.Uniform(2,4.0)] #changes from 0.0,5.0

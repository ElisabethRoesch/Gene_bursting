...
# outfile = "tester"
newTrue=log10.([0.001, 0, 0.0001, 0.01, 1000.])
#Run ABC for selected genes and the experiemental data
#----------------------------------------------------------------
@sync @parallel for i in gene_names[selectionstart:selectionend]
    test_data = generate_single_simulation_samples_m9(newTrue,500, data_scaling_RNAseq)

    #Define output file
    #----------------------------------------------------------------
    outfile_name = "$(outfile)/validate_model_9_david_100_02_500_3_0c2.txt"

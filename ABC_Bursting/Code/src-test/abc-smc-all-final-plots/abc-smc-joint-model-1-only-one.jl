...
fileending_2i="_validate_cc_100_01_295"
nsamples = 100
path_to_file_2i = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/Data/ABC_output/RNAseq/validation_simulation/cc/cc_",name,fileending_2i,".txt")
path_to_plot = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/plots/validation-simulation/model-1-cc/",name,fileending_2i,"_joint_validate_cc.pdf")
...
fig, ax = PyPlot.subplots(figsize = (15,15), ncols=3, nrows=3)
      ...
      ax[3,3][:set_xlabel]("Degradation rate",fontsize=19)
      ax[3,3][:tick_params](labelsize=12)

      ax[2,1][:set_ylabel]("Deactivation rate",fontsize=19)
      # ax[2,1][:set_xlabel]("Activation rate",fontsize=12)
      ax[2,1][:tick_params](labelsize=12)

      ax[3,1][:set_ylabel]("Degradation rate",fontsize=19)
      ...
      ax[3,2][:set_xlabel]("Deactivation rate",fontsize=19)

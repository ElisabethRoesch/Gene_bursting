...
#,"ENSMUSG00000027715"]ENSMUSG00000021835 ENSMUSG00000020717
#, "ENSMUSG00000029177"]   ENSMUSG00000018604
genes = ["ENSMUSG00000012396"]
# ENSMUSG00000018604,"ENSMUSG00000021835","ENSMUSG00000020717", "ENSMUSG00000021255", "ENSMUSG00000003032"]

a3_2i,b3_2i,c3_2i,d3_2i,e3_2i,di3_2i,w3_2i = 0,0,0,0,0,0,0
a3_serum,b3_serum,c3_serum,d3_serum,e3_serum,di3_serum,w3_serum = 0,0,0,0,0,0,0


fileending_2i="model_9_serum_genes_serum_data_"
fileending_serum="model_9_serum_genes_2i_data_"
p_1 = [-6,0.]
# p_2 = [-6,0]
# p_3 = [-6,0]
...
nsamples = 500
for name in genes
  path_to_file_2i = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/Data/ABC_output/RNAseq/model_9_huge/serum_genes/2i_data/model_9_serum_genes_2i_data_",name,"_david.txt")
  path_to_file_serum = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/Data/ABC_output/RNAseq/model_9_huge/serum_genes/serum_data/model_9_serum_genes_serum_data_",name,"_david.txt")
  path_to_plot = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/plots/model-9-huge-prior/",name,fileending_serum,"_david_joints02.pdf")
  ...
  a3_serum,b3_serum,c3_serum,d3_serum,e3_serum,f3_serum,di3_serum,w3_serum=read_one_m9(path_to_file_serum,  3, nsamples, 5)
  ...
  d_serum = hcat(convert(Array{Float64,1}, a3_serum),
              ...
              convert(Array{Float64,1}, e3_serum))
  PyPlot.ion()

  a_2i = pd.DataFrame(data= Dict( :c_act=>d_2i[:,1], :c_deact=>d_2i[:,2], :c_deg=>d_2i[:,3], :fb=>d_2i[:,4], :fb_base=>d_2i[:,5]))
  a_serum = pd.DataFrame(data= Dict( :c_act=>d_serum[:,1], :c_deact=>d_serum[:,2], :c_deg=>d_serum[:,3], :fb=>d_serum[:,4], :fb_base=>d_serum[:,5]))
      ...
      sns.distplot(e3_serum,bins=15, kde= true, hist=true,rug= false ,  color = "cornflowerblue", label = "lisi",ax=ax[5,5])
     ...
     sns.distplot(e3_2i,bins=15, kde= true, hist=true,rug= false ,   color = "salmon", label = "lisi",ax=ax[5,5])
     ...
     sns.jointplot(x="c_act", y="fb_base", data=a_2i, kind="kde", color="lightpink",ax=ax[5,1])
     ...
     sns.jointplot(x="c_deact", y="fb_base", data=a_2i, kind="kde", color="lightpink",ax=ax[5,2])
     sns.jointplot(x="c_deg", y="fb", data=a_2i, kind="kde", color="lightpink",ax=ax[4,3])
     sns.jointplot(x="c_deg", y="fb_base", data=a_2i, kind="kde", color="lightpink",ax=ax[5,3])
     sns.jointplot(x="fb", y="fb_base", data=a_2i, kind="kde", color="lightpink",ax=ax[5,4])
     ...
     sns.jointplot(y="c_act", x="fb_base", data=a_serum, kind="kde", color="cornflowerblue",ax=ax[1,5])
     ...
     sns.jointplot(y="c_deact", x="fb_base", data=a_serum, kind="kde", color="cornflowerblue",ax=ax[2,5])
     sns.jointplot(y="c_deg", x="fb", data=a_serum, kind="kde", color="cornflowerblue",ax=ax[3,4])
     sns.jointplot(y="c_deg", x="fb_base", data=a_serum, kind="kde", color="cornflowerblue",ax=ax[3,5])
     sns.jointplot(y="fb", x="fb_base", data=a_serum, kind="kde", color="cornflowerblue",ax=ax[4,5])

...
@sync @parallel for i in gene_names[selectionstart:selectionend]
    ...
    test_data = cell_cycle_simulation_generate_single_simulation_samples_m1_16666_33332([-2.8,-2.7,-2.5],295, data_scaling_RNAseq)

    outfile_name = "$(outfile)/cc_$(i)_validate_cc_500_02_295.txt"

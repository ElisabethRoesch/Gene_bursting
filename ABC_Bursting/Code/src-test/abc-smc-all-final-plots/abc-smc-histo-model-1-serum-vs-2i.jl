...
fileending_2i = string("_0.1_",n_samples,"_",tmax,"_2i_genes_2i_data")
fileending_serum = string("_0.1_",n_samples,"_",tmax,"_2i_genes_serum_data")
binsize = 15
...
for name in genes
      path_to_file_2i = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/Data/ABC_output/RNAseq/explore_distr/model_1/all_high_var_in_2i_genes_in_2i/model1_",name,fileending_2i,".txt")
      path_to_file_serum = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/Data/ABC_output/RNAseq/explore_distr/model_1/all_high_var_in_2i_genes_in_serum/model1_",name,fileending_serum,".txt")
...
for i in 1:length(genes)
    ...
    for sim in 1:length(sampled_parameter_combinations_2i[i])
        one_gene_one_simulation_result_2i = generate_single_simulation_samples_m1_250000(sampled_parameter_combinations_2i[i][sim], n_samples, data_scaling_RNAseq)
    ...
    for sim in 1:length(sampled_parameter_combinations_serum[i])
        one_gene_one_simulation_result_serum= generate_single_simulation_samples_m1_250000(sampled_parameter_combinations_serum[i][sim], n_samples, data_scaling_RNAseq)
...
for gene in 1:length(genes)
    ...
    name = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/plots/posterior_quantile/base_model_2i_genes/", genes[gene],fileending_2i,fileending_serum,"_n_tester",string(n_tester),"_binsize",string(binsize),".png")
     savefig(name)
end

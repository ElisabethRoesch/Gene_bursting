...
# names=["ENSMUSG00000022528","ENSMUSG00000027715", "ENSMUSG00000041431"] #Hes2, Ccna2, Ccnb1
names =["ENSMUSG00000022528"] #Hes2
#,"ENSMUSG00000027715"]
#, "ENSMUSG00000029177"]
...
t1 = 16666
t2 =  33332
fileending_2i = string("_serum_genes_2i_data_0.1_500_250000_",t1,"_",t2)
fileending_serum = string("_serum_genes_serum_data_0.1_500_250000_",t1,"_",t2)
p_1 = [-6,0.]
# p_2 = [-6,0]
# p_3 = [-6,0]
...
nsamples = 500
for name in names
  path_to_file_2i = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/Data/ABC_output/RNAseq/cell_cycle/serum_genes/2i_data/model1_cell_cycle_",name,fileending_2i,".txt")
  path_to_file_serum = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/Data/ABC_output/RNAseq/cell_cycle/serum_genes/serum_data/model1_cell_cycle_",name,fileending_serum,".txt")
  path_to_plot = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/plots/model-1-cc-joint/",name,fileending_2i,fileending_serum,"_joint1.pdf")

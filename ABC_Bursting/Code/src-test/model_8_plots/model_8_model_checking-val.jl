...
fileending_2i = string("_validate_model_8_david_100_02_500")
fileending_serum = string("_validate_model_8_david_100_02_500")
binsize = 15
...
for name in genes
      path_to_file_2i = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/Data/ABC_output/RNAseq/validation_simulation/model_8/",fileending_2i,".txt")
      path_to_file_serum = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/Data/ABC_output/RNAseq/validation_simulation/model_8/",fileending_serum,".txt")
...
for i in 1:length(genes)
    ...
    one_gene_experimental_result_2i = generate_single_simulation_samples_m8([-3.,-2.3,-4.,2.3], n_samples, data_scaling_RNAseq)
    one_gene_experimental_result_serum =one_gene_experimental_result_2i
...
for gene in 1:length(genes)
    ...
    fig,ax = PyPlot.subplots()
      ...
      sns.tsplot(in_para_2i,color="grey", value="Frequency", time=np.linspace(all_genes_min_max_all[gene][1], all_genes_min_max_all[gene][2], binsize),  ci=95,ax=ax)
      ...
      sns.distplot(all_genes_experimental_results_serum[gene],norm_hist=true, bins=binsize, kde= true, hist=false,rug= false ,  color = "black", label = "simulated truth",axlabel = "Product abundance",ax=ax)
    name = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/Data/ABC_output/RNAseq/validation_simulation/model_8/hist/", genes[gene],fileending_2i,"_n_tester",string(n_tester),"_binsize",string(binsize),"1.pdf")
     PyPlot.savefig(name)
end

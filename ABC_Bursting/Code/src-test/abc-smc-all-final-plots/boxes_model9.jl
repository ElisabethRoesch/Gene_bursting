...
for name in genes
      counter=counter+1
      path_to_file_2i = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/Data/ABC_output/RNAseq/model_8_0.4/serum_genes/2i_data/",fileending_2i,name,".txt")
      path_to_file_serum = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/Data/ABC_output/RNAseq/model_8_0.4/serum_genes/serum_data/",fileending_serum,name,".txt")
      data_file_2i=read_one_m8(path_to_file_2i,  3, n_samples,4)
      data_file_serum=read_one_m8(path_to_file_serum,  3, n_samples,4) #a3,b3,c3,d3,e3,di3,w3
...
for name in 1:length(genes)
      ...
      for i in 1:length(sampled_parameter_combinations_2i[name])
            ...
            push!(kst,convert(Float64,sampled_parameter_combinations_2i[name][i][4]))

      end
      a=convert(Array{Float64,1},actst)
      b=convert(Array{Float64,1},deactst)
      c=convert(Array{Float64,1},degst)
      d=convert(Array{Float64,1},kst)
...
#       #here 2
#       name = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/plots/params/",name,"logged_split_serum_2i.pdf")
#       savefig(name)
#
# end
PyPlot.ioff()

...
# genes = ["ENSMUSG00000006589", "ENSMUSG00000019539", "ENSMUSG00000020571", "ENSMUSG00000020954", "ENSMUSG00000022881", "ENSMUSG00000024646", "ENSMUSG00000025130", "ENSMUSG00000025359", "ENSMUSG00000025856", "ENSMUSG00000047751", "ENSMUSG00000050953", "ENSMUSG00000062270"]
genes = ["ENSMUSG00000025856"]
...
for name in genes
      ...
      path_to_file_serum =  string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/Data/ABC_output/RNAseq/model-1-new-genes/serum/model1_serum_", name, "_new_gene.txt")
...
for i in 1:length(genes)
    ...
    for sim in 1:length(sampled_parameter_combinations_2i[i])
        one_gene_one_simulation_result_2i = generate_single_simulation_samples_m1(sampled_parameter_combinations_2i[i][sim], n_samples, data_scaling_RNAseq)
    ...
    for sim in 1:length(sampled_parameter_combinations_serum[i])
        one_gene_one_simulation_result_serum= generate_single_simulation_samples_m1(sampled_parameter_combinations_serum[i][sim], n_samples, data_scaling_RNAseq)
...
for gene in 1:length(genes)
    ...
    name = string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/plots/params/new_genes/selection/", genes[gene],"_n_tester",string(n_tester),"_binsize",string(binsize),".pdf")
     savefig(name)
end

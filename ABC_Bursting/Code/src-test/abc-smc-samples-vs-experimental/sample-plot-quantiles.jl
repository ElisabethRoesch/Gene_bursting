...
for i in 1:length(genes)
    ...
    for sim in 1:length(sampled_parameter_combinations[i])
        one_gene_one_simulation_result= generate_single_simulation_samples_m1_200000(sampled_parameter_combinations[i][sim], n_samples, data_scaling_RNAseq)

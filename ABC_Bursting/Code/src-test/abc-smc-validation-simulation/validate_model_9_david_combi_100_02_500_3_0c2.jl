...
@sync @parallel for i in gene_names[selectionstart:selectionend]
    test_data = generate_single_simulation_samples_m9_no_deact(newTrue,500, data_scaling_RNAseq)

    #Define output file
    #----------------------------------------------------------------
    outfile_name = "$(outfile)/validate_model_9_david_100_02_250_3_0c2.txt"

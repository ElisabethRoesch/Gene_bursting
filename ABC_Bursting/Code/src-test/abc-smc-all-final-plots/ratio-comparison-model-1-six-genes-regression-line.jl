...
real_names = ["Nr0b1 in serum",  "Bmp4 in serum", "Gli2 in serum","Gli2 in 2i" , "Pecam1 in 2i", "Zfp42 in 2i" ]
# markers = ["+" , "*" , "^","+" , "*" , "^"]
...
endfile = ["serum","serum","serum","2i","2i","2i"]
counter = 0
for name in genes
      counter=counter+1
...
fig,ax = PyPlot.subplots()
      ...
      ax[:set_ylim]([-2.5,1])
      ax[:set_xlim]([-2.5,2.5])
savefig(string("/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/plots/validate/","sixgenes_frombimoduletorightpeak_regline_new_no_line.pdf"))

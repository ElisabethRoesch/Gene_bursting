...
outfile = "/project/home17/er4517/project_3/gene_bursting/ABC_Bursting/Data/ABC_output/RNAseq/validation_simulation/cc"
...
@sync @parallel for i in gene_names[selectionstart:selectionend]
    ...
    test_data = cell_cycle_simulation_generate_single_simulation_samples_m1_only_one([-2.8,-2.7,-2.5],295, data_scaling_RNAseq)

    outfile_name = "$(outfile)/cc_$(i)_validate_cc_100_02_only_one.txt"
    ...
    threshold = [0.8,0.4,0.2] #threshold regime
